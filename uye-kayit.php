...
Dükkan Girişi  </h124  ></div>
 ...
 <p><strong>Üye kayıt</strong></p>
        ...
        <input type="text" name="user" id="user" placeholder="E-posta" />
            ...
            <input type="password" name="pass"  placeholder="Şifre Tekrar" id="pass" /><br />
                ...
                <input type="text" name="user" id="user" placeholder="Ad" />
                <input type="text" name="user" id="user" placeholder="Soyad" />
